...
public class MapCompare {
    private static int hashMapW = 0;
    private static int hashMapR = 0;
    private static int linkMapW = 0;
    private static int linkMapR = 0;
    private static int treeMapW = 0;
    private static int treeMapR = 0;
    private static int hashTableW = 0;
    private static int hashTableR = 0;

    public static void main(String[] args) {
        for (int i = 0; i < 10; i++) {
            MapCompare test = new MapCompare();
            test.test(100 * 10000);
            System.out.println();
        }
